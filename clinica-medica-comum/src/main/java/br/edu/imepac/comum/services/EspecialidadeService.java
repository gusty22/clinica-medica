...
import br.edu.imepac.comum.repositories.IEspecialidadeRepository;
...
public class EspecialidadeService {
    ...
    public EspecialidadeService(ModelMapper modelMapper, IEspecialidadeRepository especialidadeRepository) {
